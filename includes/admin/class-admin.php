		...
		wp_localize_script(
			...
			array(
				...
				'i18n'    => array(
					...
					'cancel'             => __( 'Cancel', 'xoom-addons-for-elementor' ),
					'saveChanges'        => __( 'Save changes', 'xoom-addons-for-elementor' ),
					'confirmLabel'       => __( 'Confirm', 'xoom-addons-for-elementor' ),
					'singularWidgets'    => __( 'Widget', 'xoom-addons-for-elementor' ),
					'singularExtensions' => __( 'Extension', 'xoom-addons-for-elementor' ),
					'nounWidgets'        => __( 'widgets', 'xoom-addons-for-elementor' ),
					'nounExtensions'     => __( 'extensions', 'xoom-addons-for-elementor' ),
					/* translators: %s: component type, e.g. Widget. */
					'enabledNoun'        => __( '%s enabled.', 'xoom-addons-for-elementor' ),
					/* translators: %s: component type, e.g. Widget. */
					'disabledNoun'       => __( '%s disabled.', 'xoom-addons-for-elementor' ),
					'alreadyEnabled'     => __( 'Everything is already enabled.', 'xoom-addons-for-elementor' ),
					'alreadyDisabled'    => __( 'Everything is already disabled.', 'xoom-addons-for-elementor' ),
					'pendingRegion'      => __( 'Pending changes', 'xoom-addons-for-elementor' ),
					'pendingOne'         => __( '1 change pending', 'xoom-addons-for-elementor' ),
					/* translators: %d: number of pending changes. */
					'pendingMany'        => __( '%d changes pending', 'xoom-addons-for-elementor' ),
					'pendingAll'         => __( 'Apply to all components', 'xoom-addons-for-elementor' ),
					/* translators: %s: component type in plural, e.g. widgets. */
					'pendingEnable'      => __( 'Enable all %s', 'xoom-addons-for-elementor' ),
					/* translators: %s: component type in plural, e.g. widgets. */
					'pendingDisable'     => __( 'Disable all %s', 'xoom-addons-for-elementor' ),
					'restoreTitle'       => __( 'Restore defaults?', 'xoom-addons-for-elementor' ),
					'restoreText'        => __( 'These settings will be reset to their default values. This cannot be undone.', 'xoom-addons-for-elementor' ),
					'restoreCta'         => __( 'Restore defaults', 'xoom-addons-for-elementor' ),
				),
			)
		);
	}
